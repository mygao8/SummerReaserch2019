...
def _get_session_config_from_env_var(args):
    """Returns a tf.ConfigProto instance that has appropriate device_filters
    set."""
    
    """@nni.variable(nni.choice(1,2,3,4), name=inter_op)"""
    inter_op=2
    """@nni.variable(nni.choice(1,2,3,4,5,6,7,8), name=intra_op)"""
    intra_op=2
...
def train_and_evaluate(args):
    ...
    """@nni.report_final_result(total_time)""" 
...
if __name__ == '__main__':
    ...
    PARSER.add_argument(
        ...
        nargs='+',
        default='/home/tony.gao/cloudml-samples/census/estimator/data/adult.data.csv')
    PARSER.add_argument(
        '--eval-files',
    ...
    PARSER.add_argument(
	'--inter_op',
	help='inter_op_threads',
	default=2,
	type=int)
    PARSER.add_argument(
	'--intra_op',
	help='intra_op_threads',
	default=2,
	type=int)
    PARSER.add_argument(
        '--train-steps',
